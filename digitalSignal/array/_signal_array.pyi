...
class SignalArray:
    ...
    def __add__(self, other: Union[int, float, complex, complex_, SignalArray]) -> SignalArray:...

    def __sub__(self, other: Union[int, float, complex, complex_, SignalArray]) -> SignalArray:...

    def __mul__(self, other: Union[int, float, complex, complex_, SignalArray]) -> SignalArray:...

    def __pow__(self, power: Union[int, float, complex, complex_, SignalArray], modulo=None) -> SignalArray:...
